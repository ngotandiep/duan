...
class DashboardController extends Controller
{
    ...
    public function chart_dashboard()
    {
        ...
        $currentMonthRevenue = $revenuesMonth->where('month', $currentMonth)->first()->total_revenue ?? 0;
        $lastMonthRevenue = $revenuesMonth->where('month', $currentMonth - 1)->first()->total_revenue ?? 0;
        ...
        $topViewProducts = Product::withTrashed()->orderBy('view', 'desc')
            ->take(6)
            ->get();
        $comments = Comment::orderBy('rating', 'asc')
        ->get();
        ...
        $images = Image::whereIn('idProduct', $topSellingProducts->pluck('idProduct'))->get();
