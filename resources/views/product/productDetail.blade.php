        ...
        <div class="product__details__pic">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <!-- Phần hình ảnh chính của sản phẩm -->
                    ...
                    <div class="col-lg-5 col-md-4">
                        <div class="product__details__text">
                            ...
                            <h3 class="d-flex justify-content-center align-items-center">
                                <div class="format-currency">{{ $product->priceSale }}đ</div> <span class="format-currency">{{ $product->price }}đ</span>
                            </h3>
                            ...
                            <div class="product__details__option">
                                <div class="product__details__option__size">
                                    <form action="{{ route('addToCart', $product->id) }}" method="post">
                                        ...
                                        @method('POST')
                                        <span>Size:</span>
                                        @foreach (['XXXL', 'XXL', 'XL', 'L', 'M', 'S'] as $size)
                                            @if ($product->size->$size > 0)
                                                <label for="{{ strtolower($size) }}">{{ strtolower($size) }}
                                                    <input type="radio" id="{{ strtolower($size) }}" name="size" value="{{ strtolower($size) }}">
                                                </label>
                                            @endif
                                        @endforeach
                                </div>
                            ...
                            <div class="product__details__last__option">
                                <ul>
                                    ...
                                    <li><span>Phí vận chuyển:</span> Miễn Phí</li>
                                </ul>
                            </div>
                        </div>
                    </div>
